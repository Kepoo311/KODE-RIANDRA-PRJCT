 ...
 * @author venti
 */
public class history_score extends javax.swing.JFrame {

    DefaultTableModel tabelModel;
    ResultSet RsSiswa = null;
    int absen_siswa = 1;

    public history_score(int absen_siswa) {
        this.absen_siswa = absen_siswa;
        initComponents();
        tampil(absen_siswa); // Menggunakan QuizID yang diinput
        // ... (kode lainnya tetap sama)
    }

    // ...
    public void tampil(int absen_siswa) {
        String query = "SELECT * FROM quiz_result WHERE absen=?";
    ...
    private void initComponents() {
        ...
        codeTXT.setBackground(new java.awt.Color(102, 102, 102));
        codeTXT.setFont(new java.awt.Font("Segoe UI Black", 0, 24)); // NOI18N
        ...
        jLabel7.setText("CARI BERDASARKAN QuizID");
    ...
    private void cariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cariActionPerformed
        String quizID = codeTXT.getText();
        
        if (quizID == null){
            JOptionPane.showMessageDialog(this, "Pls write the quizID !");
        }
        search(quizID,absen_siswa);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(history_score.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
